...
EnableFromCurrentState() {
    ...
    if (GetKeyState("w", "P")) {
        global w_mode
        if (ToggleEnabled) {
            if (F11F12_active || GetKeyState("LControl", "P") || E_toggle) {
                Send {Blind}{Up down}
                w_mode := "arrow"
            } else {
                Send {Blind}{i down}
...
; WASD remaps
$*w::
global w_mode, F11F12_active, ToggleEnabled, E_toggle
if (!ToggleEnabled) {
    Send {Blind}{w down}
    w_mode := "pass"
    return
...
$*a::
global a_mode, F11F12_active, ToggleEnabled, E_toggle
if (!ToggleEnabled) {
    Send {Blind}{a down}
    a_mode := "pass"
    return
...
$*s::
global s_mode, F11F12_active, ToggleEnabled, E_toggle
if (!ToggleEnabled) {
    Send {Blind}{s down}
    s_mode := "pass"
    return
...
$*d::
global d_mode, F11F12_active, ToggleEnabled, E_toggle
if (!ToggleEnabled) {
    Send {Blind}{d down}
    d_mode := "pass"
    return
...
; -----------------------
; E toggle with longer keypress
$*e::
global E_toggle
E_toggle := !E_toggle
Send {Blind down}e
Sleep 50  ; hold E for 50ms; adjust if needed
Send {Blind up}e
return
